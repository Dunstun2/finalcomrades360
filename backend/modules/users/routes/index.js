...
const { me, applyRole, verifyRolePhone, adminApproveRole, listPendingRoles, updateProfile, updateAddress, requestAccountDeletion, requestEmailChange, confirmEmailChange, requestPhoneOtp, confirmPhoneOtp, changePassword, adminSetUserRole, getFullProfile, listUsersByRole, getUserById, adminCreateUser, adminSearchUserForVerify, adminForceVerify } = require('../controllers/controller');
const { getUserWallet } = require('../../finance/controllers/wallet.controller');
