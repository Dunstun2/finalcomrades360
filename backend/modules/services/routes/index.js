...
const { Service, ServiceImage, User, Category, Subcategory, Notification } = require('../../../database/models.registry');
...
const { getServiceProviderWallet } = require('../controllers/wallet.controller');
