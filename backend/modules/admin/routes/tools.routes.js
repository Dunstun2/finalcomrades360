...
const adminToolController = require('../controllers/tools.controller');
...
router.post('/orders/manual-confirm-payment', auth, adminOnly, require('../../finance/controllers/payment.controller').confirmManualPayment);
