...
const rejectProduct = async (req, res) => {
  ...
  try {
    ...
    // FIX: Sync status to 'inactive' to remove from public listings
...
const requestProductChanges = async (req, res) => {
  ...
  try {
    ...
    // FIX: Sync status to 'pending' to remove from public listings
...
const getRevenueAnalytics = async (req, res) => {
  try {
    ...
    const { Transaction } = require('../../../database/models.registry');
...
const withdrawPlatformFunds = async (req, res) => {
  try {
    ...
    const { PlatformWallet, PlatformTransaction, sequelize } = require('../../../database/models.registry');
