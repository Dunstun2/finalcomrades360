const { User, Order, Product, FastFood, AdminAuditLog, LoginHistory } = require('../../../database/models.registry');
...
exports.mergeAccounts = async (req, res) => {
  try {
    ...
    const { Wallet } = require('../../../database/models.registry');
    if (Wallet) {
...
exports.getAllOrders = async (req, res) => {
  try {
    const { Order, User, OrderItem } = require('../../../database/models.registry');
...
exports.getProductsBySeller = async (req, res) => {
  try {
    const { Product } = require('../../../database/models.registry');
...
exports.bulkToggleItems = async (req, res) => {
  try {
    ...
    const { Product, FastFood } = require('../../../database/models.registry');
    let count = 0;
...
exports.runDatabaseCleanup = async (req, res) => {
  try {
    ...
    const { Otp, Product, FastFood, AdminAuditLog } = require('../../../database/models.registry');
    const { Op } = require('sequelize');
    let count = 0;
...
exports.searchPayments = async (req, res) => {
  try {
    ...
    const { Payment, User, Order } = require('../../../database/models.registry');
    const { Op } = require('sequelize');
...
exports.getBlockedIPs = async (req, res) => {
  try {
    const { BlockedIP, User } = require('../../../database/models.registry');
...
exports.getAdvancedAnalytics = async (req, res) => {
  try {
    const { Order, User, DeliveryTask, sequelize } = require('../../../database/models.registry');
    const { Op } = require('sequelize');
...
exports.getUserSessions = async (req, res) => {
  try {
    const { userId } = req.params;
    const { LoginHistory } = require('../../../database/models.registry');
