...
const { applyHeroPromotion, myHeroPromotions, listActiveHeroPromotions, submitPaymentProof, editMyHeroPromotion, deleteMyHeroPromotion, requestRefund, getHeroRates } = require('../controllers/heroPromotion.controller');
