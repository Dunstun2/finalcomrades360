...
const ReferralTracking = require('../../../modules/marketing/models/ReferralTracking');
const User = require('../../../modules/users/models/User');
const ProductView = require('../../../modules/products/models/ProductView');
const MarketingAnalytics = require('../../../modules/marketing/models/MarketingAnalytics');
