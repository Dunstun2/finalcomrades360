const { sequelize, Payment, Order, User, Wallet, Commission, DeliveryTask, Transaction, Op } = require('../../../database/models.registry');
...
const { calculateCommission: createCommissionRecords } = require('./commission.controller');
...
const { getOrderRoutePolicy } = require('../../orders/controllers/controller');
        ...
        if (payment.checkoutGroupId) {
          ...
          for (const ord of groupOrders) {
            ...
            if (nextStatus === 'awaiting_delivery_assignment') {
              try {
                const { autoCreateDeliveryTask } = require('../../orders/controllers/transition.controller');
