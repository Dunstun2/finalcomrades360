const { Cart, Product, User } = require('../../../database/models.registry');
...
const mergeCart = async (req, res) => {
  const t = await require('../../../database/models.registry').sequelize.transaction();
  try {
...
const getCartDataInternal = async (userId, cartType = 'personal') => {
  const { Cart, Product, User, FastFood, Service, ServiceImage } = require('../../../database/models.registry');
  const { calculateItemCommission } = require('../../../utils/commissionUtils');
...
const addToCart = async (req, res) => {
  try {
    ...
    if (isFastFood) {
      ...
      const { Service } = require('../../../database/models.registry');
...
const updateCartItem = async (req, res) => {
  try {
    ...
    const { FastFood, Service } = require('../../../database/models.registry');
...
const setFastFoodOrderBatch = async (req, res) => {
  try {
    ...
    if (batchId === null || batchId === '') {
      const { Cart } = require('../../../database/models.registry');
