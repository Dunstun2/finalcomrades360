const { Product, FastFood, User, Order, OrderItem, Commission, PickupStation, DeliveryCharge, PlatformConfig, DeliveryTask, Wallet, PromoCode } = require('../../../database/models.registry');
const { autoCreateDeliveryTask } = require('./transition.controller');
const { calculateCommission } = require('../../finance/controllers/commission.controller');
...
exports.placeDirectOrder = async (req, res) => {
    ...
    try {
        ...
        setImmediate(() => {
            const { triggerAutoConfirmation } = require('./controller');
