...
const { Product, User, Category, Service, ServiceImage, FastFood, HeroPromotion, sequelize } = require('../../../database/models.registry');
...
const getHomepageBatchData = async (req, res) => {
  ...
  try {
    ...
    const fetchCategories = async () => {
      try {
        const { Category, Subcategory, Product } = require('../../../database/models.registry');
