...
const BlogComment = require('./BlogComment')(sequelize, Sequelize.DataTypes);
const BlogLike = require('./BlogLike')(sequelize, Sequelize.DataTypes);
const BlogRating = require('./BlogRating')(sequelize, Sequelize.DataTypes);
