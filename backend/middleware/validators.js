...
const validateKenyanPhone = (phone) => {
  ...
  // Strict regex: +254 OR 0, followed by 1 or 7, then EXACTLY 8 digits
...
const normalizeKenyanPhone = (p = '') => {
  ...
  // 1. If it matches +254 format already (Exactly 13 chars)
  if (/^\+254[17]\d{8}$/.test(s)) return s;

  // 2. If it's a local format (01... or 07...) (Exactly 10 digits)
