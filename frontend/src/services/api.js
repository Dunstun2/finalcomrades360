...
export const cmsApi = {
  // About Page
  getAboutPage: () => api.get('/cms/about'),
  createAboutPage: (data) => api.post('/cms/about', data),
  updateAboutPage: (data) => api.put('/cms/about', data),
  deleteAboutPage: () => api.delete('/cms/about'),

  // Team Members
  getTeamMembers: () => api.get('/cms/about/team'),
  getTeamMember: (id) => api.get(`/cms/about/team/${id}`),
  createTeamMember: (data) => {
    const isFormData = data instanceof FormData;
    return api.post('/cms/about/team', data, {
      headers: isFormData ? {} : { 'Content-Type': 'application/json' }
    });
  },
  updateTeamMember: (id, data) => {
    const isFormData = data instanceof FormData;
    return api.put(`/cms/about/team/${id}`, data, {
      headers: isFormData ? {} : { 'Content-Type': 'application/json' }
    });
  },
  deleteTeamMember: (id) => api.delete(`/cms/about/team/${id}`),

  // Contact Page (for future use)
  getContactPage: () => api.get('/cms/contact'),
  createContactPage: (data) => api.post('/cms/contact', data),
  updateContactPage: (data) => api.put('/cms/contact', data),
  deleteContactPage: () => api.delete('/cms/contact'),

  // Blog Page (for future use)
  getBlogPage: () => api.get('/cms/blog'),
  createBlogPage: (data) => api.post('/cms/blog', data),
  updateBlogPage: (data) => api.put('/cms/blog', data),
  deleteBlogPage: () => api.delete('/cms/blog'),
};
