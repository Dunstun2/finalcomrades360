...
import api, { adminApi } from '@/shared/services/api';
import { toast } from 'react-toastify';
import RoleEarningVerification from '@/modules/auth/pages/RoleEarningVerification';
...
export default function DeliveryAgents() {
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen relative overflow-hidden">
      ...
      {/* Side Slider Drawer */}
      <div 
        className={`fixed inset-0 bg-black/40 backdrop-blur-sm z-[9999] transition-opacity duration-300 ${drawerOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
