...
import { FaBox, FaSync, FaSignOutAlt, FaExclamationCircle, FaUndoAlt, FaCheckCircle, FaArrowRight, FaSearch, FaWallet } from 'react-icons/fa';
import DeliveryTaskConsole from '@/modules/delivery/components/DeliveryTaskConsole';
import HandoverCodeWidget from '@/shared/components/HandoverCodeWidget';
import { getOrderDeliveryTask } from '@/modules/delivery/components/DeliveryTaskComponents';
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex gap-2 self-start md:self-auto">
              <button
                onClick={() => window.location.href = '/station/wallet'}
