...
import SellerProviderSelector from '@/modules/seller/pages/SellerProviderSelector';
...
import AdminCreatedItemsTable from '@/modules/admin/pages/AdminCreatedItemsTable';
