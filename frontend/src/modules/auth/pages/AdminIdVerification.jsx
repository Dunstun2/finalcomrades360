...
import api from '@/shared/services/api'; // Adjust import based on your structure
...
const AdminIdVerification = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-7xl">
            ...
            {/* Image Modal */}
            {selectedImage && (
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-[9999] p-4" onClick={closeModal}>
